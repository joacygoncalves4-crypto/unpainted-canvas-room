...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "facebook-domain-verification", content: "r8u877e42k163pi3w24r7uxvpcgcth" },
      ...
      { property: "og:site_name", content: "ZP Conservação" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ZP Conservação | Limpeza e Terceirização em Brasília - DF" },
      { name: "twitter:description", content: "Empresa atuante desde 1999 — limpeza, conservação e terceirização. CNPJ 03.073.654/0001-33." },
    ],
    links: [
